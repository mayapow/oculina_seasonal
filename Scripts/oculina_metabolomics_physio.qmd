...
ggsave(here("Output", "Nov_2024","chla_nov_depth_sa_box.png"), device = "pdf", h = 6, w = 10, chla_nov_depth_sa_box)
```
...
ggsave(here("Output", "Nov_2024","sym_nov_depth_sa_box.png"), device = "pdf", h = 6, w = 10, sym_nov_depth_sa_box)
```
...
ggsave(here("Output", "Nov_2024","chla_sym_nov_depth_sa_box.png"), device = "pdf", h = 6, w = 10, chla_sym_nov_depth_sa_box)
```
...
sym_chla_scatter
ggsave(here("Output", "Nov_2024","sym_chla_scatter.png"), device = "pdf", h = 6, w = 10, sym_chla_scatter)
